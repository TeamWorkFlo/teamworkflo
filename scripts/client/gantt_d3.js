...
d3.gantt = function() {
    ...
    var taskTypes = [];
    var taskStatus = [];
    var height = $("#vis").height() - margin.top - margin.bottom-5;
    var width = $("#vis").width() - margin.r - margin.left-5;
	...
	.attr("transform", "translate(" + margin.left + ", " + margin.top + ")");
	 ...
	 svg.append("g").attr("class", "y axis").attr("transform", "translate(0, 25)").transition().call(yAxis);
