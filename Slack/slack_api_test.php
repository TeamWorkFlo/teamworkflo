...
/*
	...
	Things that need doing still
		...
		-Make all of this a function (for modularity)
*/
...
$inclusive = "1"; //a 1 means it will include messages at the latest timestamp, a 0 means it will not
...
$pretty = "0"; //determines how output is returned; if 1, shows more of json hierarchy, if 0, dumps result in kinda messily

/*
html POST request code (from here: http://stackoverflow.com/questions/5647461/how-do-i-send-a-post-request-with-php)
*/
$url = $urlBase . $apiCommand . "?token=" . $userToken . "&channel=" . $channelID . "&latest=" . $latestTimestamp . "&oldest=" . $oldestTimestamp . "&inclusive=" . $inclusive . "&count=" . $msgCount . "&unreads=" . $unreadMessages . "&pretty=" . $pretty;
//echo $url . "\n";
$data = array();
